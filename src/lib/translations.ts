...
const ui: Record<string, { en: string; es: string }> = {
  ...
  'store.minPrice': { en: 'Min price', es: 'Precio mínimo' },
  'store.priceRange': { en: 'Price range', es: 'Rango de precio' },
  'store.size': { en: 'Size', es: 'Tamaño' },
  'store.allSizes': { en: 'All Sizes', es: 'Todos los Tamaños' },
  'product.chooseSize': { en: 'Choose an option', es: 'Elige una opción' },
